...
@Service
public class FindAnswerCodeByResolvedAndAccountId {
    private final UserResponseDAO userResponseDAO;

    @Autowired
    public FindAnswerCodeByResolvedAndAccountId(UserResponseDAO userResponseDAO) {
        this.userResponseDAO = userResponseDAO;
    }

    public List<UserResponse> execute(String accountId, Boolean resolved){
        return userResponseDAO.findByResolvedAndAccountId(resolved, accountId);
    }
